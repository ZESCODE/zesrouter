...
**Generated**: 2026-09-02 via [Archify](https://github.com/tt-a1i/archify)  
...
The topology below is generated by Archify — a self-contained, interactive HTML diagram with zoom, pan, and themed rendering:

- [Interactive Topology](/zesrouter.html) — hover, zoom, pan; dark theme; cards for ports and models
- [Architecture JSON IR](/zesrouter/zesrouter.architecture.json) — typed source specification
